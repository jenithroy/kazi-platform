...
export const metadata = {
  title: 'Hoodies | Kazi Manufacturing',
  description: 'Premium blank hoodies for your brand. Pullover, zip-up, and oversized styles. MOQ 50 units.',
};
      ...
      <div className="pt-32 bg-kazi-charcoal text-white py-16 px-6 md:px-12 lg:px-20">
        <div className="max-w-[1200px] mx-auto">
          ...
          <nav className="flex items-center gap-2 font-sans text-xs text-white/40 mb-8 uppercase tracking-[0.12em]">
            ...
            <span>/</span>
            <Link href="/shop/hoodies" className="hover:text-white/70 transition-colors">Shop</Link>
            <span>/</span>
            <span className="text-white/70">Hoodies</span>
          </nav>
          ...
          <h1 className="font-sans text-4xl md:text-5xl font-normal mb-4">Hoodies</h1>
          <p className="font-sans text-lg text-white/60 max-w-xl">
            Premium fleece, built for every season. From classic pullovers to oversized statement pieces.
          </p>
        </div>
      </div>
      ...
      <section className="py-20 px-6 md:px-12 lg:px-20">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex items-center justify-between mb-10">
            ...
            <Link href="/shop/tshirts" className="font-sans text-xs font-semibold uppercase tracking-[0.12em] text-kazi-green hover:text-kazi-green-dark transition-colors">
              View T-Shirts →
            </Link>
          </div>
