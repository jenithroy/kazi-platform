...
const filledButton =
  "inline-flex h-12 w-full items-center justify-center gap-2 rounded-sm btn-gradient px-6 font-body text-sm font-semibold tracking-wide text-bone disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto";
const outlineButton =
