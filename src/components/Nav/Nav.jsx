...
// `to: '/'` + `scrollTo` links land on the homepage and scroll to that section id
// (see useScrollToLocationTarget) — works the same whether you're already on "/" or
// navigating in from another route like /atelier. Plain `to` links just navigate.
const LINKS = [
  ...
  return (
    <header className={`${styles.nav} ${isScrolled ? styles.scrolled : ''}`}>
      <div className={styles.inner}>
        ...
        <Link to="/" className={styles.logo} aria-label="Kazi Manufacturing home" />

        <div className={styles.actions}>
          <Link to="/quote" className={styles.cta}>
            Get a Quote
          </Link>
          <Link to="/account/login" className={styles.iconButton} aria-label="Account">
